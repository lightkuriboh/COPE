		...
		<div class = "panel-footer">
			...
			<?php 
				...
				<?php
					...
					{
						if ($row['Visibility'] != 0)
							echo "<button class = 'btn btn-success' id = 'ul_btn' type = 'submit' name = 'CCode' > submit</button><br>";
						else
...
<section class = 'well'>
	...
	<?php 
		...
		echo "<div><ul style = 'float:left' class = 'pager'><li><a href = '/submission/problem/".$_REQUEST['code']."'> Status </a></li>"; 
		echo "<li><a href = '/Ranking/".$_REQUEST['code']."'> Rank </a></li></ul><br><br></div>"; 
	?>
	<h2 style = 'text-align:center;'>
		<?php echo "<button class = 'btn btn-info'>".$row['Name']."</button>"; ?>
	</h2>
	<?php
		if ($row['Visibility'] != 0) {
